...
<html>
	...
	if($reservation["reservation_salle"] == $lieux["room_id"]){?>
						...
						<div class="form-group" id="prix_reservation">
							...
							<div class="input-group">
								...
								<input type="number" step="any" name="prix_resa" id="prix_calcul" class="form-control" value="<?php echo $reservation['reservation_prix'];?>" aria-describedby="currency-addon">
							</div>
