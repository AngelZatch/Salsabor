						...
						<div id="maturities-checked">
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" step="any" name="promotion-e-<?php echo $p["key"];?>" class="form-control">
										</div>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" step="any" name="promotion-p-<?php echo $p["key"];?>" class="form-control">
										</div>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input type="number" step="any" name="prix_achat" id="prix-calcul-<?php echo $p["key"];?>" class="form-control prix-display" value="<?php echo $p["tarif_global"];?>">
								</div>
							</div>
						</div>
					</section>
