       ...
       <div class="row">
           ...
           <div class="col-sm-8 main" id="right-bordered">
               ...
               <div class="progress">
                 ...
                 <div class="btn-toolbar">
                   ...
                   <a href="personnalisation.php" role="button" class="btn btn-default"><span class="glyphicon glyphicon-credit-card"></span> Règlement des achats <span class="glyphicon glyphicon-arrow-right"></span></a>
                </div> <!-- btn-toolbar -->
               <?php foreach($row_panier as $p){ ?>
                 <section id="details-<?php echo $p["panier_id"];?>">
                     <form action="" method="post" target="_blank">
                      <p class="produit-title"><?php echo $p["produit_nom"];?></p>
                         ...
                         <div class="row">
                           ...
                           <div class="form-group">
                               ...
                               <div class="input-group">
                                   ...
                                   <input type="text" name="prix_achat" id="prix_calcul" class="form-control" value="<?php echo $p["tarif_global"];?>">
                               </div>
                           </div>
                       </div>
                    </form>
           ...
           <div class="col-sm-2 shopping-section">
               ...
               <?php foreach($row_panier as $p){
                   ...
                   <li id="details-<?php echo $p["panier_id"];?>-toggle" class="active" style="cursor:pointer;" role="presentation"><a href="#"><?php echo $p["produit_nom"];?></a></li>
                   <?php } else { ?>
                   <li id="details-<?php echo $p["panier_id"];?>-toggle" style="cursor:pointer;" role="presentation"><a href="#"><?php echo $p["produit_nom"];?></a></li>
                   <?php }
                } ?></ul>
           </div>
       </div>
