			...
			<div class="row">
				...
				<div class="col-lg-10 col-lg-offset-2 main">
					...
					<div class="col-lg-8 irregulars-container">
						<button class='btn btn-default btn-block btn-modal' id='link-all' onclick='linkAll()' title='Délier tous les cours hors forfait'><span class='glyphicon glyphicon-arrow-right'></span> Trouver assoc.</button>
