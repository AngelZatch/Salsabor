       ...
       <div id="navbar" class="navbar-collapse collapse">
           <ul class="nav navbar-nav navbar-right">
             <li><a href=""><span class="glyphicon glyphicon-user"></span> Dev_Version</a></li>
              ...
              <li class="notification-option" title="Echéances en retard"><a href="" class="notification-icon"><span class="glyphicon glyphicon-repeat"></span><span class="badge" id="badge-echeances"></span></a>
              </li>
