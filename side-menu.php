<div class="col-sm-2 col-md-2 sidebar" id="large-menu" style="display:block;">
	<ul class="nav nav-sidebar">
		...
		<ul class="nav nav-sidebar collapse" id="collapse-actions">
			<li><a href="inscription.php?status=contact" class="main-option"><span class="glyphicon glyphicon-user"></span> Inscrire une personne</a></li>
			<li><a href="catalogue.php" class="main-option"><span class="glyphicon glyphicon-th"></span> Vendre un produit</a></li>
			<li><a href="resa_add.php" class="main-option"><span class="glyphicon glyphicon-record"></span> Réserver une salle</a></li>
			<li><a href="eleve_inviter.php" class="main-option"><span class="glyphicon glyphicon-heart-empty"></span> Donner une invitation</a></li>
		</ul>
		...
		<ul class="nav nav-sidebar collapse" id="collapse-timetable">
			...
			<li><a href="irregulars.php" class="main-option"><span class="glyphicon glyphicon-ice-lolly-tasted"></span> Participations irrégulières</a></li>
		...
		<ul class="nav nav-sidebar collapse" id="collapse-data">
			...
			<li><a href="tarifs_liste.php" class="main-option <?php if(basename($_SERVER['PHP_SELF'])=='tarifs_liste.php') echo "active";?>"><span class="glyphicon glyphicon-scale"></span> Tarifs de Location</a></li>
		</ul>
