<div class="col-sm-2 col-md-2 sidebar" id="large-menu" style="display:block;">
   <ul class="nav nav-sidebar">
      ...
      <li><a href="tarifs.php" class="main-option <?php if(basename($_SERVER['PHP_SELF'])=='tarifs.php') echo "active";?>"><span class="glyphicon glyphicon-scale"></span> Tarifs</a></li>
...
<div class="col-sm-1 col-md-1 sidebar" id="small-menu" style="display:none;">
    <ul class="nav nav-sidebar">
        ...
        <li><a href="tarifs.php" class="main-option <?php if(basename($_SERVER['PHP_SELF'])=='tarifs.php') echo "active";?>" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Tarifs"><span class="glyphicon glyphicon-scale"></span></a></li>
