...
<div class="col-sm-1 col-md-1 sidebar" id="small-menu" style="display:none;">
    <ul class="nav nav-sidebar">
        ...
        <li><a href="dashboard.php" class="main-option" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Forfaits et abonnements"><span class="glyphicon glyphicon-credit-card"></span></a></li>
        <li><a href="tarifs_liste.php" class="main-option <?php if(basename($_SERVER['PHP_SELF'])=='tarifs_liste.php') echo "active";?>" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Tarifs de Location"><span class="glyphicon glyphicon-scale"></span></a></li>
