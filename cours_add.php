               ...
               <div class="col-sm-9" id="solo-form">
               	<form action="cours_add.php" method="post" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="intitule" class="col-sm-3 control-label">Intitulé <span class="span-mandatory">*</span></label>
					   ...
					   <div class="form-group">
						   <label for="type" class="col-sm-3 control-label">Type de cours<span class="span-mandatory">*</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group">
						   <label for="date_debut" class="col-sm-3 control-label">Date de Début<span class="span-mandatory">*</span></label>
						   <div class="col-sm-9">
						...
						<div class="form-group" id="recurring-options" style="display:none;">
						   <label for="date_fin" class="col-sm-3 control-label">Date de Fin<span class="span-mandatory">*</span></label>
						   <div class="col-sm-9">
							   <input type="date" class="form-control" name="date_fin" id="date_fin" onChange="checkCalendar(false, true)">
						  </div>
							  <label for="frequence_repetition" class="col-sm-3 control-label">Récurrence<span class="span-mandatory">*</span></label>
							   <div class="col-sm-9">
						...
						<div class="form-group">
						   <fieldset>
						   <label for="herue_debut" class="col-sm-3 control-label">Début à <span class="span-mandatory">*</span></label>
						   <div class="col-sm-9">
						...
						<div class="form-group">
							<fieldset>
							<label for="prof_principal" class="col-sm-3 control-label">Professeur <span class="span-mandatory">*</span></label>
							<div class="col-sm-9">
							...
							<label for="prof_remplacant" class="col-sm-3 control-label">Remplaçant <span class="span-mandatory">*</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group">
						   <label for="niveau" class="col-sm-3 control-label">Niveau<span class="span-mandatory">*</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group">
						   <label for="lieu" class="col-sm-3 control-label">Lieu<span class="span-mandatory">*</span></label>
						   <div class="col-sm-9">
