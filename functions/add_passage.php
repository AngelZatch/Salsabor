...
$search = $db->query("SELECT * FROM adherents JOIN produits_adherents ON eleve_id=produits_adherents.id_adherent WHERE numero_rfid='$adherent[numero_rfid]'");
...
try{
	...
	VALUES(:eleve_id, :salle, :date, :cours_id, :status)');
	$new->bindParam(':eleve_id', $adherent["numero_rfid"]);
