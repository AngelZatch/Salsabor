...
$rfid = $_POST["rfid"];
$produit = $db->query("SELECT *, produits_adherents.actif AS produitActif FROM produits_adherents JOIN produits ON id_produit_foreign=produits.produit_id WHERE id_user_foreign=$eleve")->fetch(PDO::FETCH_ASSOC);
