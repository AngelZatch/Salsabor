...
$session_details = $db->query("SELECT s.session_id, session_name, session_start, session_end, room_name, color_value, COUNT(passage_id) AS participations_count FROM cours s
