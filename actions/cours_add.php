...
<form action="planning.php" method="post" class="form-horizontal" role="form">
  ...
  <div class="form-group">
       ...
       <div class="col-sm-9 col-sm-offset-3">
           <input type="checkbox" name="recurrence" id="recurrence" value="1" data-toggle="toggle" data-on="Récurrent" data-off="Non récurrent" data-onstyle="success" data-offstyle="danger" onClick="toggleRecurringOptions()">Est récurrent<span class="mandatory">*</span>
       </div>
   </div>
